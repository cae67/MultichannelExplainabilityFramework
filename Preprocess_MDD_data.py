...
folderpath1 = "C:/Users/antho/OneDrive/Documents/Calhoun_Lab/Projects/Spectral_Explainability/MDD/RawData/HC/"
folderpath2 = "C:/Users/antho/OneDrive/Documents/Calhoun_Lab/Projects/Spectral_Explainability/MDD/RawData/MDD/"
...
for f in range(0,2):
    ...
    for i in range(0,len(files)):
        ...
        channels_to_use = ['EEG Fp1-LE', 'EEG Fp2-LE', 'EEG F7-LE', 'EEG F3-LE', 'EEG Fz-LE', 'EEG F4-LE', 'EEG F8-LE', 'EEG T3-LE', 'EEG C3-LE', 'EEG Cz-LE', 'EEG C4-LE', 'EEG T4-LE', 'EEG T5-LE', 'EEG P3-LE', 'EEG Pz-LE', 'EEG P4-LE', 'EEG T6-LE', 'EEG O1-LE', 'EEG O1-LE']
    ...
    if f == 0:
        ...
        filename1 = 'C:/Users/antho/OneDrive/Documents/Calhoun_Lab/Projects/Spectral_Explainability/MDD/segmented_hc1_data'
        filename2 = 'C:/Users/antho/OneDrive/Documents/Calhoun_Lab/Projects/Spectral_Explainability/MDD/segmented_hc2_data'
        ...
        filename1 = 'C:/Users/antho/OneDrive/Documents/Calhoun_Lab/Projects/Spectral_Explainability/MDD/segmented_mdd1_data'
        filename2 = 'C:/Users/antho/OneDrive/Documents/Calhoun_Lab/Projects/Spectral_Explainability/MDD/segmented_mdd2_data'
...
# Show How to Reload Data

filename1 = 'C:/Users/antho/OneDrive/Documents/Calhoun_Lab/Projects/Spectral_Explainability/MDD/segmented_hc1_data.npy'

import numpy as np

fun = np.load(filename1,allow_pickle=True).item()
fun4 = fun['subject']
print(np.unique(fun4))
filename1 = 'C:/Users/antho/OneDrive/Documents/Calhoun_Lab/Projects/Spectral_Explainability/MDD/segmented_hc2_data.npy'

fun2 = np.load(filename1,allow_pickle=True).item()
fun3 = fun2['subject']
print(np.unique(fun3))